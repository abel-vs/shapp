...
Map<String, Category> get shopCategories {
  return {
    ...
    'restaurant': Category(
        name: "restaurant", image: "assets/images/shops/restaurant.png"),
    'sports':
...
Map<String, Category> get productCategories {
  return {
    ...
    'drinks':
        Category(name: "drinks", image: "assets/images/products/drinks.png"),
    'health':
        Category(name: "health", image: "assets/images/products/health.png"),
    'beauty':
        Category(name: "beauty", image: "assets/images/products/cosmetics.png"),
  };
}
